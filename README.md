...
A port of [`mafintosh`s](https://github.com/mafintosh) latest iteration over Node.js core streams with a series of improvements.

``` js
import * as streamx from "https://denopkg.com/chiefbiiko/streamx"
```

[![Travis](http://img.shields.io/travis/chiefbiiko/streamx.svg?style=flat)](http://travis-ci.org/chiefbiiko/streamx) [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/chiefbiiko/streamx?branch=master&svg=true)](https://ci.appveyor.com/project/chiefbiiko/streamx)
